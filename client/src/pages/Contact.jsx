      ...
      <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
        ...
        <div className="relative px-6 pb-20 pt-24 sm:pt-32 lg:static lg:px-8 lg:py-48">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            ...
            <p
              className="mt-6 text-lg/8 text-accent"
            >
              Every great space starts with a conversation. Whether you’re early
              in the planning phase or ready to build, feel free to call, email,
              or send a message—whatever works best for you.
            </p>
